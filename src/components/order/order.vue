...
export default {
  ...
  methods: {
        ...
        if (valid) {
          ...
          this.$axios.post(url, this.order).then(response => {
            if (response.data.status === 0) {
              ...
              this.$router.push({
                path : '/pay',
                query: { orderid: response.data.message.orderid }
              })
    ...
    //         address      : '桥洞',
    //         mobile       : '12312345678',
    //         email        : 'meilaiban@38.com',
    //         post_code    : '518101',
    //         payment_id   : '6',
    //         express_id   : '1',
    //         expressMoment: 20,
    //         message      : 'henduobeitai',
    //         goodsAmount  : 88888,
    //         cargoodsobj  : {
    //           '87': 84,
    //           '88': 12,
    ...
    //           '94': 14
    //         },
    //         goodsids: '87,88,90,92,93,94'
    //       }
    //       this.$axios.post(url, Objnew).then(response => {
    //         if (response.data.status === 0) {
    //           console.log("ok")
    //         }
    //       })
