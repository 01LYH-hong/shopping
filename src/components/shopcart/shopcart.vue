                            ...
                            <tbody>
                                ...
                                <tr v-for="(item,index) in goodsList" :key="item.id">
                                    ...
                                    <td width="104" align="center">
                                        <!-- {{item.buycount}} -->
                                        <inputnumber :initCount='item.buycount' :goodsId='item.id' @goodsCountChange='getChangeGoods'></inputnumber>
                                    </td>
    ...
    getGoodsListData() {
      ...
      this.$axios.get(url).then(res => {
        ...
        res.data.message.forEach(goods => {
          //console.log(goods);
          //console.log(goods.buycount);
          //console.log(localGoods[goods.id]);
